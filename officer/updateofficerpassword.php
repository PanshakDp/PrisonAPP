...
if(empty($password) || empty($newpass) || empty($comfirmpass)){
    ...
    $sql="SELECT Password FROM prisonwarder_tbl WHERE Password='$password'";
    $result=mysqli_query($conn,$sql);
    if(mysqli_num_rows($result)>0){
        $update="UPDATE prisonwarder_tbl SET Password='$newpass' WHERE Password='$password'";
...
<html>
<head>
<title>UPDATE OFFICER PASSWORD</title>
</head>
<body bgcolor="#006600">

<form action="updateofficerpassword.php" method="post">
...
<td align="center"><a href='officerpanel.php'><input type="button" name="" value="Back"></a></td>
</tr>
</table>
</form>
</body>

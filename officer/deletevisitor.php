...
<body>
	<table align='center' border='1' bgcolor='green' width='1000' cellpadding='8' cellspacing='0' height='200'>
...
$sql="SELECT * FROM visitor,visit WHERE visitor.id='$id' AND visit.id='$id' ";

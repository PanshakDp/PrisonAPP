...
echo '<td width="3%"><b><a href="updatecourt.php?id='.$row['National_id']. '" style="color:green">Edit</a></font></b></td>';

echo '<td width="3%"><b><a href="deletecourt.php?id='.$row['National_id']. '" style="color:red">Delete</a></font></b></td>';

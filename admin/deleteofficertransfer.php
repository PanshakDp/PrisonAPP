...
include 'config.php';
$id=$_GET['id'];
$result=mysqli_query($conn,"SELECT * FROM officer WHERE National_id='$id'");
?>
...
$delete=mysqli_query($conn,"DELETE FROM officer WHERE National_id='$id'");
if($delete){
print "<script language='javascript'>
	alert('Successfully deleted!...')
	location.href='viewofficer.php'
	</script>";
}
else{
print "<script language='javascript'>

<html>
<head>
  <title>DISCHARGED DETAILS  </title>
...
$sel= mysqli_query($conn,"SELECT  * FROM $tbl_name WHERE state='$state' ORDER BY Full_Name");
if(mysqli_num_rows($sel)>0){
echo"<table align='center' width='100%' border='0' cellpadding='3' cellspacing='2' bgcolor='green'>
<caption><h3>DISCHARGED INMATE(S) DETAILS. </h3></caption>
<tr bgcolor='green  '>
...
<br/>
          ...
          <tr>
			<td align="center"><a href="adminpanel.php" target="_parent"> Admin <b>|</b></a>
